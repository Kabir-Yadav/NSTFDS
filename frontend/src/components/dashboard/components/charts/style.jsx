const createChartConfig = ({ isDarkMode, completionRate, budgetUtilization, implementationRate }) => {
    const pieChartProps = {
        motionConfig: "wobbly",
        animate: true,
        initial: [
  ...
  `;
    ...
    return { pieChartProps, elevatedCardClass, chartColors, chartTheme, pieDataCompletion, pieDataBudget, pieDataSchool };
};
